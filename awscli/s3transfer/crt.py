...
from botocore.utils import ArnParser, is_s3express_bucket
...
class S3ClientArgsCreator:
    ...
    def _default_get_make_request_args(
        ...
        arn_parser = S3ArnParamHandler()
        accesspoint_arn_details = arn_parser.handle_arn(call_args.bucket)
        if accesspoint_arn_details:
